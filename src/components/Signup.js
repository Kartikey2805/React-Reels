...
const Signup = (props) => {
  ...
  return loading === true ? (
    ...
    <div>
      {(error!== null && error.length > 0)? <Error type={type} message={error} /> : null}
        <h2 style={{textAlign:"center"}}>Welcome to Instagram Reels</h2>
      <div className={classes.centerDivs}>
        <Grid container spacing={2}>
          <Grid item sm={6} xs={12}>
             <img src="./images/instagramLogo.jpg" style={{width: "-webkit-fill-available"}}/>
          </Grid>
